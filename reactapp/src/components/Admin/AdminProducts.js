...
class AdminProducts extends Component {
    ...
    editProduct = (productId) => {
        this.props.history.push("/admin/editProduct/" + productId);
    }
                                        ...
                                        this.state.products.length === 0 ?
                                            ...
                                            this.state.products.map((product) => (
                                                <tr key={product.productId}>
                                                    ...
                                                    <td>
                                                        <ButtonGroup>
                                                            <Button size="sm" variant="outline-primary" onClick={this.editProduct.bind(this, product.productId)} ><FontAwesomeIcon icon={faEdit} /><b> Edit</b></Button>
